            ...
            <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card-box table-responsive">
                            <h4 class="m-t-0 header-title">List of Active Trips</h4>
...
<script type="text/javascript">
    ...
    {
        var did = a;
        window.location.href = '<?php echo $sitename; ?>master/' + a + '/viewactive_order.htm';
    }     
</script>
<?php
...
<script type="text/javascript">
    $('#normalexamples').dataTable({
        ...
        //"scrollX": true,
        "searching": true,
        "sAjaxSource": "<?php echo $sitename; ?>pages/dataajax/gettablevalues.php?types=activeordertable"
    });
</script>