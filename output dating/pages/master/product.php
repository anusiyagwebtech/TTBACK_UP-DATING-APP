...
<script type="text/javascript" >
    ...
    function checkdelete(name)
    {
        ...
        {
            if (confirm("Please confirm you want to Delete this Product(s)"))
            {
                return true;
            }
            else
            ...
            <div class="container-fluid">
                ...
                <div class="col-sm-12">
                     <div class="btn-group pull-right m-t-15">
                        <a href="<?php echo $sitename; ?>master/addproduct.htm"><button type="button" class="btn btn-default">Add New</button></a>                        
                    </div>
            ...
            <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card-box table-responsive">
                            <h4 class="m-t-0 header-title">List of Product</h4>
...
<script type="text/javascript">
    ...
    {
        var did = a;
        window.location.href = '<?php echo $sitename; ?>master/' + a + '/editproduct.htm';
    }
</script>
<?php
