...
<script type="text/javascript" >
    ...
    function checkdelete(name)
    {
        ...
        {
            if (confirm("Please confirm you want to Delete this Subscription(s)"))
            {
                return true;
            }
            else
            ...
            <div class="container-fluid">
                ...
                <div class="col-sm-12">
                     <div class="btn-group pull-right m-t-15">
                        <a href="<?php echo $sitename; ?>master/addsubscription.htm"><button type="button" class="btn btn-default">Add New</button></a>                        
                    </div>
            ...
            <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card-box table-responsive">
                            <h4 class="m-t-0 header-title">List of Subscription</h4>
                 ...
                 <form name="form1" method="post" action="">
                                ...
                                <tr align="center">
                                    <th style="width:5%;">S.id</th>
                                     <th style="text-align: left;">Subscription Name</th>
...
<script type="text/javascript">
    ...
    {
        var did = a;
        window.location.href = '<?php echo $sitename; ?>master/' + a + '/editsubscription.htm';
    }
</script>
<?php
...
<script type="text/javascript">
      $('#normalexamples').dataTable({
        ...
        //"scrollX": true,
        "searching": true,
        "sAjaxSource": "<?php echo $sitename; ?>pages/dataajax/gettablevalues.php?types=subscriptiontable"
    });
</script>
