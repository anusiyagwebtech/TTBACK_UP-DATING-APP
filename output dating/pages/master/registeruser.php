...
<!--                     <div class="btn-group pull-right m-t-15">
                  ...
                  <h4 class="page-title">Form Submission</h4>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="<?php echo $sitename; ?>">Form Submission</a></li>
...
<script type="text/javascript">
    $('#normalexamples').dataTable({
        ...
        //"scrollX": true,
        "searching": true,
        "sAjaxSource": "<?php echo $sitename; ?>pages/dataajax/gettablevalues.php?types=registertable"
    });
</script>