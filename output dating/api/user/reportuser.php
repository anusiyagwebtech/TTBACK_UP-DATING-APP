...
if(
    !empty($data->user_id) && !empty($data->reported_user_id)
){
   
$userrow = $checkvaliduser->fetch(PDO::FETCH_ASSOC);
$query = "INSERT INTO `abuse_report_tbl` (`user_id`,`reported_user_id`) VALUES ('".$data->user_id."','".$data->reported_user_id."')";
...
$stmt->execute();
  // set response code - 400 bad request
    ...
    // tell the user
    echo json_encode(array("success" => "true", "error" => "false","message" => "Reported Successfully"));
}
