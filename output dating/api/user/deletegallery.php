...
if(
    !empty($data->gallery_id) 
){
   
$query = "DELETE FROM `gallery` WHERE `id`='".$data->gallery_id."' ";
...
$stmt->execute();
  // set response code - 400 bad request
    ...
    // tell the user
    echo json_encode(array("success" => "true", "error" => "false","message" => "Gallery Deleted Successfully"));
}
