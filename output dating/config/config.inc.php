...
if ($_SERVER['HTTP_HOST'] == 'localhost') {
    $db = new PDO('mysql:host=localhost;dbname=datingapp;charset=utf8mb4', 'root', '');
    $db->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
    $db->setAttribute(PDO::ATTR_EMULATE_PREPARES, false);
    $sitename = 'http://localhost/ttbilling/datingapp/';
    $fsitename = 'http://localhost/ttbilling/datingapp/';
    $actual_link = "http://" . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI'];
    define('WEB_ROOTS', $fsitename);
    define('WEB_ROOT', $sitename);
    $docroot = $_SERVER['DOCUMENT_ROOT'] . "/dating_app/";
} else {
    $db = new PDO('mysql:host=localhost;dbname=datingapp;charset=utf8mb4', 'datingapp', 'datingapp');
    $db->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
    $db->setAttribute(PDO::ATTR_EMULATE_PREPARES, false);
    $connection_string = mysqli_connect("localhost", "datingapp", 'datingapp', "datingapp");
    $sitename = "https://ttbilling.in/datingapp/";
    $site = 'https://ttbilling.in/datingapp/';
    $fsitename = 'https://ttbilling.in/datingapp/';
