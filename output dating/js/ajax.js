...
// {
    ...
    // {
        ...
        // oRequestsubcat.open("POST", "http://localhost/reachec/admin/config/functions_ajax.php", true);
...
function delimg()
{
    if (oRequestsubcat.readyState == 4)
    {
        if (oRequestsubcat.status == 200)
        {
            ...
            ///swal(oRequestsubcat.responseText, "", "success");
        } else
        {
            document.getElementById("delimage").innerHTML = oRequestsubcat.responseText;
            //swal(oRequestsubcat.responseText, "", "error");
        }
    }
}
...
function deletemultiimage(a, b, c, d, e, f, disid)
{
    ...
    if (a != '' && b != '' && c != '' && d != '' && e != '' && f != '')
    {
        ...
        oRequestsubcat.open("POST", Settings.base_url + "http://localhost/reachec/admin/config/functions_ajax.php", true);
...
function getstate(a)
{
    ...
    if (a != '')
    {
        ...
        oRequestsubcat.open("POST", "http://localhost/reachec/admin/config/function_ajax.php", true);
